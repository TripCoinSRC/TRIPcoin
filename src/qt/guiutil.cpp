...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("TRIPcoin"))
        return false;
...
{
    // Convert TRIPcoin:// to TRIPcoin:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("TRIPcoin://"))
    {
        uri.replace(0, 12, "TRIPcoin:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "TRIPcoin.lnk";
}
...
{
    return GetAutostartDir() / "TRIPcoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("TRIPcoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  TRIPcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
// "QMainWindow    { background-image: url(:/icons/tripcoinbg);"
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
                      ...
                      "QPushButton    { background: rgb(52,180,164); color: rgb(21,21,21); }"
                      ...
                      "QMenu::item:selected { background-color: rgb(40,140,130); }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(52,180,164); border-left-style: solid; border-left-width: 6px; }"
                      ...
                      "QTreeView::item:selected { background-color: rgb(40,140,130); }"
                      "QTableView::item:selected { background-color: rgb(52,180,164); }"
